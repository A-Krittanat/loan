...
public class LoanControllerTest {
    ...
    void testGetLoanInfoByCustomerIdEquals1() throws Exception {
        ...
        assertEquals("102-220-2200", data.get("account_payable"));
        assertEquals("102-210-2020", data.get("account_receivable"));
        assertEquals(3200, data.get("principal_amount"));
    ...
    @DisplayName("Test get loan info by customer id 3 should return thrown exception")
    @Test
